  ...
  return (
    <div className="min-h-screen pt-16 px-4">
      <div className="max-w-4xl mx-auto py-8">
        <h1 className="text-4xl font-bold mb-8 text-center">Le Stress au Travail</h1>
        <div className="prose prose-lg mx-auto">
          <p className="text-lg mb-6">
            La sophrologie propose des solutions concrètes pour gérer le stress professionnel 
            et retrouver un équilibre entre vie personnelle et professionnelle.
          </p>
