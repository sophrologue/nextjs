    ...
    <div className="min-h-screen pt-16 px-4 ">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        <p className="text-lg text-gray-700 mb-6">
          La sophrologie accompagne l&apos;enfant et l&apos;adolescent dans les
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            <p className="text-lg mb-4">
              Comme les adultes, les adolescents ont besoin d&apos;un équilibre
              pour être heureux et bien grandir. La sophrologie leur fait
              découvrir les nombreuses ressources qu&apos;ils ont en eux, et
              leur offre des outils pour mieux gérer leurs émotions dans un
              monde en constante évolution.
            </p>
            <p className="text-lg mb-2 font-semibold text-[#007562]">
              Un enfant heureux est un enfant qui s&apos;adapte au monde qui
              l&apos;entoure.
            </p>
          </div>

          {/* Enfants 6-12 ans  --> 6.29 삭제 */}
          ...
          <div className="bg-blue-50 rounded-2xl shadow p-6">
            ...
            <p className="mb-3 text-gray-700">
              L&apos;adolescence est une période délicate, marquée par de grands
              changements physiques, psychiques et émotionnels.
              L&apos;adolescent doit prendre son autonomie affective pour
              devenir adulte, ce qui n&apos;est pas toujours simple.
            </p>
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4">
              ...
              <li>
                Accompagnement pour aborder la vie plus positivement et donner
                du sens à son existence
              </li>
            </ul>
            <div className="bg-white border-l-4 border-blue-400 p-4 rounded mb-2">
              <span className="font-medium text-blue-700">
                La sophrologie aidera votre adolescent à se sentir plus épanoui
                et serein dans sa vie quotidienne.
              </span>
            </div>
          </div>
          ...
          <div className="bg-purple-50 rounded-2xl shadow p-6">
            ...
            <div className="bg-white border-l-4 border-purple-400 p-4 rounded">
              <span className="font-medium text-purple-700">
                Les techniques apprises en sophrologie deviennent des outils
                précieux pour toute la vie.
                <br />
                <span className="block mt-2">
                  Durée et méthodes ajustées selon l&apos;âge et la maturité,
        ...
        <div className="mt-8 text-center">
          <span className="text-gray-500 text-xs">
            &copy; {new Date().getFullYear()} Catherine Fabrici Sophrologie.
