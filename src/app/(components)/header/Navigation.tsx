      ...
      <nav className="hidden md:flex items-center justify-center flex-1">
        <ul className="flex items-center justify-center gap-8 text-sm">
          <li>
            <Link
              href="/"
              className={`relative transition-all duration-300 font-medium px-3 py-2 rounded-lg group ${
                isActive("/")
            ...
            >
              Accueil
              <span
                className={`absolute bottom-0 left-0 h-0.5 bg-[#005649] transition-all duration-300 ${
          ...
          <li className="relative group">
            <Link
              href="/sophrologie"
              className={`relative flex items-center gap-1 transition-all duration-300 font-medium px-3 py-2 rounded-lg ${
